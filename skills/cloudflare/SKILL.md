...
| Debug failures and trace application requests | Local Explorer, Workers Logs and Traces | Verify request flows and binding state locally, or investigate deployed runtime errors | `workers-verification` skill; [Observability](references/observability/README.md) |
