...
1. Read [Wrangler](../wrangler/SKILL.md), resolving the path relative to this skill file, and follow its target selection, configuration, secrets, and validation guidance.
