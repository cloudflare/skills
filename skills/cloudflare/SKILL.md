...
| Build and deploy whenever code is pushed | Workers Builds | Connect a Git repository to automated builds and deployments | `workers-deployments` skill; [Builds docs](https://developers.cloudflare.com/workers/ci-cd/builds/) |
| Test branch changes, release production code, or roll back | Workers Previews; Workers versions and deployments | Choose the supported preview workflow and verify resources before testing or releasing | `workers-deployments` skill; [Deployment docs](https://developers.cloudflare.com/workers/versions-and-deployments/) |
