...
| Set up a new or checked-out Worker or framework app | Workers tooling + bindings | Configure the app and its resources through a verified local request | `cloudflare-app-bootstrap` skill; [automatic configuration](https://developers.cloudflare.com/workers/framework-guides/automatic-configuration/) |
