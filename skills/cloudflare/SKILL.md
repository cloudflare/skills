...
| Add customer login, sessions, or Access protection to a Workers app | Workers + application auth provider or Access | Integrate application identity and verify protected routes | `cloudflare-app-auth` skill; [Workers Access integration](https://developers.cloudflare.com/workers/configuration/cloudflare-access/) |
