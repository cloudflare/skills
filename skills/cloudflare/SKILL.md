...
| Connect bots to Slack, Discord, Telegram, or other messaging channels | Workers + Agents SDK | Verify platform events, isolate conversations, and deliver replies through the chosen SDK | `cloudflare-chat-bots` skill; [Chat SDK integration](https://developers.cloudflare.com/agents/runtime/communication/chat-sdk/) |
